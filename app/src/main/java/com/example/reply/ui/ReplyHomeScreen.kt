...
fun ReplyHomeScreen(
    ...
    // this kind of view is used to show a side drawer of the list of replies
    // when accessing the a detail page, meaning clicking on one of the replies
    if (navigationType == ReplyNavigationType.PERMANENT_NAVIGATION_DRAWER
        ...
        // if the current page doesn't need a drawer

        // add if statement to show either the replies list (home page) or
        // replies detail depending on the case
...
private fun ReplyAppContent(
    ...
    Box(modifier = modifier) {
        // only display navbar on navigation type NAVIGATION_RAIL
        ...
        Column(
            ...
            // only display if navigationType is BOTTOM_NAVIGATION using animated visibility
